...
export function AppShell() {
  ...
  return (
    <div className="flex flex-col h-dvh">
      ...
      <nav className="shrink-0 bg-white border-t border-neutral-100 flex items-center justify-around px-2 pt-2 z-40" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 0.5rem)' }}>
